...
To keep thing simple, I decided to only focus on Windows for now because it's by far the most popular OS of my target audience.
...
A build, as well as the source code, is now available on GitHub:
